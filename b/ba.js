                    ...
                    <div class="row mb-3">
                        <div class="col-md-8">
                            <div class="input-group">
                                ...
                                <button class="btn btn-outline-primary" onclick="(async () => { await loadAndExeFn('open_entind_crud', ['no-loader-element', 1, 'modalContentForEntInd', 'commonFnToRunAfter_ba_ViewCall', 1], 'loader', 'https://cdn.jsdelivr.net/gh/sifr-in/cdn@7262bc9/cmn/ei.min.js'); })()">

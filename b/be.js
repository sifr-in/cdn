...
<input id="lDvV/n" class="form-control" autocomplete="off" type="text" tabindex="4" />
                  ...
                  <tr>
                    ...
                    <td>
                      <input id="lNvSph" class="form-control form-control-sm to_add" autocomplete="off" type="text" readonly tabindex="5" />
                    </td>
                    <td>
...
<input id="lNvV/n" class="form-control" autocomplete="off" type="text" tabindex="8" />
                ...
                <tfoot>
                  ...
                  <tr>
                    ...
                    <td>
                      <input id="lPd" class="form-control form-control-sm" autocomplete="off" type="text" placeholder="PD" tabindex="10" />
                    </td>
                    <td></td>
                    <td></td>
                    <td></td>
              ...
              <table id="tbl_left_eye_measurements" class="table table-bordered table-sm mb-0">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <input id="rDvCyl" class="form-control form-control-sm" autocomplete="off" type="text" readonly tabindex="12" />
                    </td>
                    <td>
...
<input id="rDvV/n" class="form-control" autocomplete="off" type="text" tabindex="14" />
                  ...
                  <tr>
                    <td class="fw-bold">NV</td>
                    <td>
                      <input id="rNvSph" class="form-control form-control-sm to_add" autocomplete="off" type="text" readonly tabindex="15" />
                    </td>
                    <td>
                      <input id="rNvCyl" class="form-control form-control-sm" autocomplete="off" type="text" readonly tabindex="16" />
                    </td>
                    <td>
...
<input id="rNvV/n" class="form-control" autocomplete="off" type="text" tabindex="18" />
                ...
                <tfoot>
                  ...
                  <tr>
                    <td class="text-center fw-bold">PD</td>
                    <td>
                      <input id="rPd" class="form-control form-control-sm" autocomplete="off" type="text" placeholder="PD" tabindex="20" />
                    </td>
                    <td></td>
                    <td></td>
                    <td></td>

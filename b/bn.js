...
<div class="modal-body">
 <form id="addItemForm">
  <div class="mb-3">
   ...
   <textarea class="form-control" id="new_item_nm" rows="3" placeholder="Enter item name (multiple lines allowed)"
...
<div class="modal-footer">
 <div class="d-flex gap-2 w-100">
  ...
  <button type="button" class="btn btn-outline-secondary flex-fill" id="item_add_with_stock_btn"
